...
async function copy(s, setCopied) {
  try {
...
export default function PaymentDetailPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      {/* Sticky subheader */}
      <div className="sticky top-0 z-20 border-b border-[#ede9e2] bg-[rgba(252,249,244,0.8)] backdrop-blur">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-2xl border border-[#e8e5df] bg-white p-5">
              <h3 className="text-sm font-semibold text-[#3f342c]">Customer</h3>
              <div className="mt-3 text-sm">
                <div className="text-[#3f342c]">
                  {p?.customer?.name ||
            ...
            {/* Booking */}
            <div className="rounded-2xl border border-[#e8e5df] bg-white p-5">
              <h3 className="text-sm font-semibold text-[#3f342c]">Booking</h3>
              <div className="mt-3 text-sm">
                {p?.booking_id ? (
                  <Link
            ...
            <div className="rounded-2xl border border-[#e8e5df] bg-white">
              <div className="flex items-center justify-between border-b border-[#eeeae3] px-5 py-3">
                <h3 className="text-sm font-semibold text-[#3f342c]">
                  Refunds
                </h3>
            ...
            {/* Metadata */}
            <div className="rounded-2xl border border-[#e8e5df] bg-white p-5">
              <h3 className="text-sm font-semibold text-[#3f342c]">Metadata</h3>
              {p?.metadata && Object.keys(p.metadata).length > 0 ? (
                ...
                <div className="mt-2 text-sm text-[#7a6a58]">No metadata</div>
              )}
            </div>
          </div>
            ...
            <div className="rounded-2xl border border-[#e8e5df] bg-white p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <div className="flex items-center justify-between gap-2">
                  <span className="text-[#7a6a58]">Payment Intent</span>
                  <div className="flex items-center gap-2">
                ...
                {p?.latest_charge && (
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-[#7a6a58]">Latest Charge</span>
                    <div className="flex items-center gap-2">
            ...
            <div className="rounded-2xl border border-[#e8e5df] bg-white p-5">
              ...
              <div className="mt-3 flex flex-col gap-2 text-sm">
                ...
                {p?.links?.dashboard_payment && (
                  ...
                  >
                    <span className="inline-flex items-center gap-2">
                      <ExternalLink className="h-4 w-4" /> Stripe payment
                    </span>
                    <ExternalLink className="h-4 w-4" />
                  </a>
                )}
                {p?.links?.dashboard_pi && (
                  ...
                  >
                    <span className="inline-flex items-center gap-2">
                      <ExternalLink className="h-4 w-4" /> Stripe PI
                    </span>
                    <ExternalLink className="h-4 w-4" />
                  </a>
                )}
