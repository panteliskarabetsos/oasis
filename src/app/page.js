...
export default function Home() {
  ...
  return (
    <main className="font-light text-[#2f2f2f] bg-[#f4f1ec]">
      ...
      {/* ================== WAYS TO EXPERIENCE OASIS (NEW) ================== */}
      <section className="bg-[#f4f1ec] py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            eyebrow="Ways to arrive"
            title="Three ways to experience Oasis"
            subtitle="Join a retreat, shape a private gathering, or simply start with a gentle conversation."
            center
          />
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              className="relative rounded-3xl border border-[#e8e2d8] bg-white/90 p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all"
            >
              <div className="inline-flex items-center gap-2 rounded-full bg-[#f7f2ea] border border-[#eadfce] px-3 py-1 text-[10px] uppercase tracking-[0.2em] text-[#8b6f47]">
                <Sparkles className="h-3 w-3" />
                Retreats
              </div>
              <h3 className="mt-4 text-xl font-serif text-[#4d3d33]">
                Join a curated retreat
              </h3>
              <p className="mt-2 text-sm text-[#6b625a] leading-relaxed">
                Seasonal, small-group gatherings that blend rest, ritual and
                connection to the Cretan land.
              </p>
              <ul className="mt-3 space-y-1.5 text-sm text-[#4a4a4a]">
                <li>• Fixed dates & gentle structure</li>
                <li>• Shared table, shared stories</li>
                <li>• Ideal for solo travellers & duos</li>
              </ul>
              <div className="mt-5">
                <LinkWithLoader href="/retreats">
                  <button className="inline-flex items-center gap-2 rounded-full border border-[#e0dcd4] bg-white px-4 py-2 text-sm font-medium text-[#5a4a3f] hover:bg-[#faf7f1]">
                    Explore retreats →
                  </button>
                </LinkWithLoader>
              </div>
            ...
            >
              ...
              <p className="mt-2 text-sm text-[#6b625a] leading-relaxed">
                For families, friends or teams who want the space all to
                themselves — with support in designing the flow.
              </p>
              <ul className="mt-3 space-y-1.5 text-sm text-[#4a4a4a]">
                <li>• Tailored to your group size</li>
                <li>• Birthdays, milestones, offsites</li>
                <li>• Flexible menus & rituals</li>
              </ul>
              <div className="mt-5">
                <LinkWithLoader href="/private">
                  <button className="inline-flex items-center gap-2 rounded-full border border-[#e0dcd4] bg-white px-4 py-2 text-sm font-medium text-[#5a4a3f] hover:bg-[#faf7f1]">
                    Private gatherings →
                  </button>
                </LinkWithLoader>
            ...
            >
              ...
              <p className="mt-2 text-sm text-[#6b625a] leading-relaxed">
                If you&apos;re not sure what fits yet, we can talk through
                ideas, timing and what you&apos;re hoping this will feel like.
              </p>
              <ul className="mt-3 space-y-1.5 text-sm text-[#4a4a4a]">
                <li>• 20–30 minutes on Zoom or audio</li>
                <li>• No pressure, no hard sell</li>
                <li>• You leave with clear next steps</li>
              </ul>
              <div className="mt-5">
                <LinkWithLoader href="/appointments">
                  <button className="inline-flex items-center gap-2 rounded-full bg-[#8b6f47] px-4 py-2 text-sm font-medium text-white hover:bg-[#a78b62] shadow-sm">
                    Schedule a call →
                  </button>
                </LinkWithLoader>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-10 flex flex-col items-center gap-2 text-center">
            <div className="flex flex-col sm:flex-row gap-3 items-center justify-center">
              ...
              <LinkWithLoader href="/appointments">
                <button className="rounded-full border border-[#e0dcd4] bg-white px-6 py-2.5 text-sm text-[#5a4a3f] hover:bg-[#faf7f1]">
                  Prefer to talk first? Schedule a call
                </button>
              </LinkWithLoader>
            </div>
            <p className="mt-3 text-xs text-[#8b7a6b] uppercase tracking-[0.22em]">
      ...
      <section className="relative bg-[#8b6f47] text-white text-center py-20 px-6 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mt-4">
            <LinkWithLoader href="/experiences">
              <button className="bg-white text-[#5a4a3f] px-8 py-4 rounded-full font-medium hover:bg-[#f4f1ec] transition-all shadow-md">
                Book a Journey
              </button>
            </LinkWithLoader>
            <LinkWithLoader href="/retreats">
              <button className="border border-white/70 bg-white/5 text-white px-6 py-3 rounded-full text-sm hover:bg-white/15 transition-all">
